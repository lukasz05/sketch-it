import { paletteGrey, paletteColor } from "./colors.mjs";
import { UnknownShapeError } from "./utils.mjs";
  ...
  pushCoord(newCoord) {
    if (this.currentShape == null) {
      throw new UnknownShapeError(
        "Tried to push x,y before starting any shape"
      );
    }
    this.size += 1;
    if (this.limit != null && this.size > this.limit) {
